...
class _PurchaseAgreementDialogState extends ConsumerState<PurchaseAgreementDialog> {
  ...
  final _installmentsController = TextEditingController(text: '5');
                    ...
                    children: [
                      ...
                      Expanded(
                        child: TextFormField(
                          ...
                          validator: (val) {
                            if (val == null || val.trim().isEmpty) return 'Count * is required';
                            if (int.tryParse(val.trim()) == null) return 'Enter valid integer';
                            return null;
                          },
                        ),
                      ),
