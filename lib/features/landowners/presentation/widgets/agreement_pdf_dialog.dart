...
class AgreementPdfService {
  static Future<Uint8List> generatePurchaseAgreementPdf({
    ...
    final totalKd = LandUnitConverter.sqFtToKattaDhur(landAreaSqFt);
            ...
            children: [
              ...
              pw.TableHelper.fromTextArray(
                ...
                data: [
                  ...
                  ['Total Land Area', '${CalculationEngine.indianNumberFormat.format(landAreaSqFt.round())} Sq. Ft. (${totalKd.katta} Kattha ${totalKd.dhur} Dhur)'],
              ...
              pw.Bullet(text: 'The Purchaser agrees to disburse payments strictly as per the agreed $installmentCount installment schedule.', style: const pw.TextStyle(fontSize: 9)),
  ...
  static Future<void> shareViaWhatsApp({
    ...
    final formattedPrice = 'Rs. ${CalculationEngine.indianNumberFormat.format(totalPrice.round())}';
    final totalKd = LandUnitConverter.sqFtToKattaDhur(landAreaSqFt);
    final formattedArea = '${CalculationEngine.indianNumberFormat.format(landAreaSqFt.round())} Sq. Ft. (${totalKd.katta} Kattha ${totalKd.dhur} Dhur)';
